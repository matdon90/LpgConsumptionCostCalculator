...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(LpgConsumptionCostCalculator.Web.App_Start.FontAwesomeBundleConfig), "RegisterBundles")]
...
namespace LpgConsumptionCostCalculator.Web.App_Start
{
	public class FontAwesomeBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new StyleBundle("~/Content/fontawesome").Include("~/Content/Styles/font-awesome.css", new CssRewriteUrlTransform()));
		}
	}
}